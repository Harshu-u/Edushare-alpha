...
SECRET_KEY = 'django-insecure-$*u27p!gq3!(qe2+l6%=pqa1k83mp22c(s!nq$p61-b7df=$u@'
...
# Prefer PostgreSQL if environment variables are set, otherwise fall back to sqlite3
